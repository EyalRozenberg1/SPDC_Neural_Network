...
from spdc_nn.data.utils import n_KTP_Kato, nz_MgCLN_Gayer
from spdc_nn.utils.utils import PP_crystal_slab
from spdc_nn.utils.utils import SFG_idler_wavelength
...
class Interaction(ABC):
    ...
    def __init__(
        ...
        self.pump_coefficient = pump_coefficient
        ...
        if crystal_basis:
            ...
            self.crystal_coefficient = crystal_coefficient
    ...
    def pump_coefficients(
        ...
        elif self.pump_coefficient == "load":
    ...
    def crystal_coefficients(
        ...
        elif self.crystal_coefficient == "custom":
